...
public class MathUtilDemo {
    ...
    public static void main(String[] args) {
        ...
        for (int i : integers) System.out.printf
                ("The value in element integer array is : %1d." + "\n", i);

        System.out.print("\n" + "The random doubles array : " + "\n");
        System.out.print("___________________________________________________" + "\n");

        for (double i : doubles) System.out.printf
                ("The value in element double array is : %f." + "\n", i);
