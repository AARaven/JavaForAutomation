...
public class AbstractDemo {
    ...
    public static void main( String[] args ) {
        ...
        System.out.printf( "The area of square is %.1f.\n", square.getArea() );
        
        System.out.printf( "\nThe perimeter of circle is %.1f.\n", circle.getPerimeter() );
        System.out.printf( "The perimeter of rectangle is %.1f.\n", rect.getPerimeter() );
        System.out.printf( "The perimeter of square is %.1f.\n", square.getPerimeter() );
        
        System.out.print( String.format( "\nThe point with coordinate x: %.1f and y: %.1f is %s\n"
