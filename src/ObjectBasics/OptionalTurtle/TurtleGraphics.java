    ...
    void moveTurtle( Direction direction, int steps ) {
        ...
        switch ( direction ) {
            ...
            case UP:
                ...
                if ( ( this.position.getY_position() - steps ) <= 0 ) {
                    ...
                    while ( temp_Y_Position > 0 ) {
                        this.board[ temp_Y_Position ][ this.position.getX_position() ] = coloredCellChar;
                        temp_Y_Position--;
                    }
                ...
                this.position.setY_position( ( this.position.getY_position() - steps ) <= 0
                        ? 0
            ...
            case DOWN:
                ...
                this.position.setY_position( ( ( this.position.getY_position() + steps ) >= this.board.length )
                        ? this.board.length - 1
                        : ( this.position.getY_position() + steps ) );
                break;
            ...
            case LEFT:
                ...
                if ( ( this.position.getX_position() - steps ) <= 0 ) {
                    ...
                    while ( temp_X_Position > 0 ) {
                        this.board[ this.position.getY_position() ][ temp_X_Position ] = coloredCellChar;
                        temp_X_Position--;
                    }
                ...
                this.position.setX_position( ( ( this.position.getX_position() - steps ) <= 0
                        ? 0
            ...
            case RIGHT:
                ...
                this.position.setX_position( ( ( this.position.getX_position() + steps ) >= this.board.length )
                        ? this.board.length - 1
                        : this.position.getX_position() + steps );
                break;
