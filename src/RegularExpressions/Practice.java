...
public class Practice {
    ...
    public static void main(String[] args) {
        ...
        Pattern secondPattern = Pattern.compile("(^[2][0-9][1-9][3-9])|(^[3-4][0-9][0-9][0-9])|(^[5][0][0-4][0-3])");
        Matcher secondMatcher = secondPattern.matcher("5043");
        ...
        Matcher fourthMatcher = fourthPattern.matcher("12/12/2018");
        ...
        Pattern fifthPattern = Pattern.compile("(\\bregular\\b)|(\\d[19]68)");
